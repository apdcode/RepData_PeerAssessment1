...
Checking for missing values in each column using is.na() and sapply reveals that there are **no missing observations** for **date** and **interval**, and **2304** missing observations in the **steps** column. Of course, the total number of missing values in the dataset is **2304**.
