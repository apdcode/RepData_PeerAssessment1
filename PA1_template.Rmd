...
The total number of steps taken in this dataset, is **`r nsteps`**. 
...
### 3.2 Average and median steps per day
The 5-minute interval which contains the maximum average steps per day, is **`r maxint$interval[1]`**.
